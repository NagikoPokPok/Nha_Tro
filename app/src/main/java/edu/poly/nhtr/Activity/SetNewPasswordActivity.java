...
import edu.poly.nhtr.presenters.SetNewPasswordPresenter;
import edu.poly.nhtr.utilities.Constants;
import edu.poly.nhtr.utilities.PreferenceManager;

public class SetNewPasswordActivity extends AppCompatActivity implements SetNewPasswordInterface {
    ImageView back;
    ...
    private void setOnclickListener(){
        ...
        updatePassword.setOnClickListener(v -> {
            ...
            String newPasswordConfirm = newPassConf.getText().toString();
            User user = new User(email, newPassword, newPasswordConfirm);
            setNewPasswordPresenter.UpdatePassword(preferenceManager, user, mAuth);
...
//                        // Handle failure
//                        updateSuccess("Cập nhật mật kẩu thất bại");
//                    });
//        } else {
